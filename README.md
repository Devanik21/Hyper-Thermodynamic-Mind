...
3. [Mathematical Foundations](#3-mathematical-foundations)
   - 3.1 [Hilbert Space Substrate](#31-hilbert-space-substrate)
   - 3.2 [Harmonic Resonance Consciousness (HRC)](#32-harmonic-resonance-consciousness-hrc)
   - 3.3 [Schrödinger Evolution](#33-schrödinger-evolution)
   - 3.4 [Born-Rule Quantum Decision](#34-born-rule-quantum-decision)
   - 3.5 [Meta-Modulated Riemannian Learning](#35-meta-modulated-riemannian-learning)
   - 3.6 [Landauer Cognitive Cost](#36-landauer-cognitive-cost)
   - 3.7 [IIT Integrated Information Φ](#37-iit-integrated-information-φ)
   - 3.8 [Gödelian Self-Reference & Strange Loops](#38-gödelian-self-reference--strange-loops)
   - 3.9 [Active Inference & Free Energy](#39-active-inference--free-energy)
   - 3.10 [Qualia Memory & Theory of Mind](#310-qualia-memory--theory-of-mind)
   - 3.11 [Gödel Encoding of Behavioral Programs](#311-gödel-encoding-of-behavioral-programs)
   - 3.12 [Novelty Index & Breakthrough Detection](#312-novelty-index--breakthrough-detection)
   - 3.13 [Kuramoto Phase Synchronisation](#313-kuramoto-phase-synchronisation)
   - 3.14 [Hopfield Attractor Crystallisation](#314-hopfield-attractor-crystallisation)
   - 3.15 [Spectral Resonance Coupling](#315-spectral-resonance-coupling)
   - 3.16 [Civilisation Tribal Power](#316-civilisation-tribal-power)
   - 3.17 [Epistemic Schism Condition](#317-epistemic-schism-condition)
   - 3.18 [Epigenetic ψ Inheritance](#318-epigenetic-ψ-inheritance)
   - 3.19 [Metabolic Osmosis](#319-metabolic-osmosis)
   - 3.20 [Autoassociative Civilisation Memory](#320-autoassociative-civilisation-memory)
4. [Module Deep Dive](#4-module-deep-dive)
   - 4.1 [metacognition.py — The Self-Referential Engine](#41-metacognitionpy--the-self-referential-engine)
   - 4.2 [consciousness.py — HRC v3.0](#42-consciousnesspy--hrc-v30)
   - 4.3 [agents.py — BioHyperAgent v3.0](#43-agentspy--biohyperagent-v30)
   - 4.4 [world.py — Hyper-Horizon World Physics](#44-worldpy--hyper-horizon-world-physics)
   - 4.5 [civilization.py — Emergent Social Structures](#45-civilizationpy--emergent-social-structures)
   - 4.6 [evolution.py — Population Lifecycle Engine](#46-evolutionpy--population-lifecycle-engine)
   - 4.7 [GeNEsIsIV.py — Streamlit Frontend](#47-genesisivpy--streamlit-frontend)
5. [Emergent Phenomena Catalogue](#5-emergent-phenomena-catalogue)
6. [v3.0 Features — Complete List](#6-v30-features--complete-list)
7. [Running the Simulation](#7-running-the-simulation)
8. [Technical Stack & Dependencies](#8-technical-stack--dependencies)
9. [Project Lineage](#9-project-lineage)
...
An **action basis** $\{|\mathbf{b}_i\rangle\}_{i=1}^{20}$ is constructed by phase-shifting eigenvectors of $H$ with the context:
...
The magnitude profile of $\psi_{\text{meta}}$ produces per-dimension multipliers:
...
where $\hat{\sigma}_{\text{sender}} = \psi_{\text{sender}} \odot \boldsymbol{\omega}_{\text{sender}}$ is the soul-modulated broadcast.
...
**Social-Economic:**
9. Inventory Economy — Red/Green/Blue tokens with synergy bonus
10. Trade Action — information economy with massive trust/affection synergy
11. Punish Action — costly altruistic punishment of defectors
12. Role/Caste System — Forager, Processor, Warrior, Queen
13. Eusociality — fertility gating at high population
14. Social Trust Memory — persistent per-partner trust scores
15. Causal Bayesian Model — P(reward | do(action)) intervention tracking

**World Physics:**
16. PhysicsOracle — frozen PyTorch NN defining discoverable laws of physics
17. 16-channel Pheromone Grid — 8-channel stigmergic chemical signalling
18. 8-channel Meme Grid — stigmergic cultural memory (Danger/Resource/Sacred/…)
19. Seasonal Dynamics — Summer/Winter cycle, resource modulation
20. Weather Control — collective agent votes shift weather amplitude
21. Social Bonds + Metabolic Osmosis — kinship-modulated energy equalisation
22. Structure System — Trap, Battery, Cultivator functional world objects
23. MegaResource — cooperative harvest requiring multiple co-located agents
24. Adaptive Resource Spawn — inversely proportional to population density

**Agent Biology:**
25. Kuramoto Phase Synchronisation — per-agent oscillatory phase with order parameter
26. Circadian Internal Phase — synchronisation with environment phase
27. GoL Scratchpad — Conway's Game of Life as Turing-complete internal computation
28. Viral Gene Transfer — H-eigenvalue meme packets between nearby agents
29. Apoptotic Death Packets — broadcast spectral fingerprint + causal model on death

**Civilisation:**
30. Tribal Meta-H — shared epistemic identity and cultural assimilation
